...
1. Type a value and then a keyword.
2. Press the required console key next.
3. **Add a space** at the end to trigger the log.

> **Warning:** Make sure to include a **space** at the end of the log, and do not press any key other than the space.
